...
function isPlainObject(x) {
  return x !== null && typeof x === "object" && /* a check for empty prototype would be more typical, but that
     doesn't play well with objects created in different vm contexts */
  (!x.constructor || x.constructor.name === "Object") && (x.toString ? x.toString() : Object.prototype.toString.call(x)) === "[object Object]" && /* check for reasonable markers that the object isn't an element for react & preact/compat */
  !("props" in x && (x.$$typeof || x.constructor === void 0));
}
...
var StyleSheetContext = import_react.default.createContext(void 0);
var StyleSheetConsumer = StyleSheetContext.Consumer;
var StylisContext = import_react.default.createContext(void 0);
StylisContext.Consumer;
var mainSheet = new StyleSheet();
var mainStylis = createStylisInstance();
function useStyleSheet() {
  return (0, import_react.useContext)(StyleSheetContext) || mainSheet;
}
function useStylis() {
  return (0, import_react.useContext)(StylisContext) || mainStylis;
}
function StyleSheetManager(props) {
  var _a2 = (0, import_react.useState)(props.stylisPlugins), plugins = _a2[0], setPlugins = _a2[1];
  ...
  return import_react.default.createElement(
    ...
    { value: styleSheet },
    import_react.default.createElement(StylisContext.Provider, { value: stylis }, true ? import_react.default.Children.only(props.children) : props.children)
  );
}
var Keyframes = (
  /** @class */
...
function flatten(chunk, executionContext, styleSheet, stylisInstance) {
  ...
  if (isFunction(chunk)) {
    if (isStatelessFunction(chunk) && executionContext) {
      ...
      if (typeof result === "object" && !Array.isArray(result) && !(result instanceof Keyframes) && !isPlainObject(result)) {
...
function ThemeProvider(props) {
  ...
  return import_react.default.createElement(ThemeContext.Provider, { value: themeContext }, props.children);
}
var identifiers = {};
...
function useStyledComponentImpl(forwardedComponent, props, forwardedRef, isStatic) {
  ...
  var theme = determineTheme(props, (0, import_react.useContext)(ThemeContext), defaultProps) || EMPTY_OBJECT;
  ...
  var generatedClassName = useInjectedStyle(componentStyle, isStatic, context, true ? forwardedComponent.warnTooManyClasses : void 0);
  ...
  ] = foldedComponentIds.concat(styledComponentId, generatedClassName !== styledComponentId ? generatedClassName : "", context.className || "").filter(Boolean).join(" ");
...
function createStyledComponent(target, options, rules) {
  ...
  var WrappedStyledComponent = import_react.default.forwardRef(forwardRef);
  ...
  WrappedStyledComponent.withComponent = function withComponent(tag) {
    ...
    var newComponentId = previousComponentId && "".concat(previousComponentId, "-").concat(isTag(tag) ? tag : escape(getComponentName(tag)));
...
function createGlobalStyle(strings) {
  ...
  var GlobalStyleComponent = function(props) {
    var styleSheet = useStyleSheet();
    var stylis = useStylis();
    var theme = import_react.default.useContext(ThemeContext);
    var instanceRef = import_react.default.useRef(styleSheet.allocateGSInstance(styledComponentId));
    ...
    {
      (import_react.default.useInsertionEffect || import_react.default.useLayoutEffect)(function() {
        if (!styleSheet.server) {
          renderStyles(instance, props, styleSheet, theme, stylis);
          return function() {
...
function withTheme(Component) {
  var WithTheme = import_react.default.forwardRef(function(props, ref) {
    ...
    return import_react.default.createElement(Component, __assign({}, props, { theme: themeProp, ref }));
  });
  ...
  function() {
    function ServerStyleSheet2() {
      ...
      this._emitSheetCSS = function() {
        ...
        return "<style ".concat(htmlAttr, ">").concat(css2, "</style>");
      };
      ...
      this.getStyleElement = function() {
        ...
        var props = (_a2 = {}, _a2[SC_ATTR] = "", _a2[SC_ATTR_VERSION] = SC_VERSION, _a2.dangerouslySetInnerHTML = {
        ...
        return [import_react.default.createElement("style", __assign({}, props, { key: "sc-0-0" }))];
      };
      this.seal = function() {
        _this.sealed = true;
      };
    ...
    ServerStyleSheet2.prototype.collectStyles = function(children) {
      if (this.sealed) {
        throw throwStyledComponentsError(2);
      }
      return import_react.default.createElement(StyleSheetManager, { sheet: this.instance }, children);
    };
    ServerStyleSheet2.prototype.interleaveWithNodeStream = function(input) {
      {
