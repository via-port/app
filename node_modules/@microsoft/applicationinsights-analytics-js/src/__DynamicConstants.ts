...
export const _DYN_DISABLE_EXCEPTION_TR0 = "disableExceptionTracking";  // Count: 3
export const _DYN_AUTO_TRACK_PAGE_VISI1 = "autoTrackPageVisitTime";  // Count: 4
...
export const _DYN_TRACK_PREVIOUS_PAGE_9 = "trackPreviousPageVisit";  // Count: 3
export const _DYN_SEND_PAGE_VIEW_INTER10 = "sendPageViewInternal";  // Count: 7
export const _DYN_SEND_PAGE_VIEW_PERFO11 = "sendPageViewPerformanceInternal";  // Count: 3
export const _DYN_POPULATE_PAGE_VIEW_P12 = "populatePageViewPerformanceEvent";  // Count: 3
export const _DYN_HREF = "href";  // Count: 6
export const _DYN_SEND_EXCEPTION_INTER13 = "sendExceptionInternal";  // Count: 2
...
export const _DYN__CREATE_AUTO_EXCEPTI14 = "CreateAutoException";  // Count: 3
export const _DYN_ADD_TELEMETRY_INITIA15 = "addTelemetryInitializer";  // Count: 4
export const _DYN_DURATION = "duration";  // Count: 10
export const _DYN_LENGTH = "length";  // Count: 5
export const _DYN_IS_PERFORMANCE_TIMIN16 = "isPerformanceTimingSupported";  // Count: 2
export const _DYN_GET_PERFORMANCE_TIMI17 = "getPerformanceTiming";  // Count: 2
export const _DYN_NAVIGATION_START = "navigationStart";  // Count: 4
export const _DYN_SHOULD_COLLECT_DURAT18 = "shouldCollectDuration";  // Count: 3
export const _DYN_IS_PERFORMANCE_TIMIN19 = "isPerformanceTimingDataReady";  // Count: 2
...
export const _DYN_PAGE_VISIT_START_TIM20 = "pageVisitStartTime";  // Count: 2
