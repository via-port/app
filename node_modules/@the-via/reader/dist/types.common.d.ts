...
export type KLEElem = Partial<KLEDimensions & OptionalDimensions & Formatting & Ghosted & Stepped & Homing & Decal & TextSize & Profile & SwitchInfo> | string;
...
export type DefinitionVersionMap = {
    v2: VIADefinitionV2;
    v3: VIADefinitionV3;
};
export type KeyboardDictionary = Record<string, DefinitionVersionMap>;
export type DefinitionVersion = keyof KeyboardDictionary[keyof KeyboardDictionary];
